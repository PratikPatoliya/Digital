...
import { UBusiness } from '../redux/action/BusinessData.action';
...
const UpdateBusiness = ({ route, navigation }) => {
    console.log("routerouterouterouteroute", route.params.data);
    const updateUser = route.params.data;
    ...
    // const filterdata = useSelector(state => state?.BusinessDataReducer?.userGetData)
    ...
    const [obj, setObj] = useState({
        companyName: updateUser.company_Name,
        mobileNumber: updateUser.mobile_Number,
        companyEmailAddress: updateUser.company_Email_Address,
        companyWebsiteOptional: updateUser.company_Website_Optional,
        companyAddress: updateUser.company_Address,
        companyDescription: updateUser.company_Description,
        selectBussinessCategory: updateUser.select_Bussiness_Category,
    });
