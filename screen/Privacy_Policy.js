...
const Privacy_Policy = ({ navigation }) => {
  return (
    <View>
      <Header2 inamel="chevron-back-outline" title="Privacy Policy" isBack={() => navigation.goBack()} />
      <ScrollView>
        <Text style={{ fontSize: 22 }}>1. INTRODUCTION</Text>
        <Text style={{ width: "90%", alignSelf: 'center' }}>Demos is committed to protecting your privacy and security. This policy explains how and why we use your personal data, to ensure you remain informed and in control of your information.
