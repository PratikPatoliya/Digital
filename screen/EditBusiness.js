...
const EditBusiness = ({ navigation }) => {
    ...
    return (
        <View >
            ...
            <ScrollView>
                <View style={{ backgroundColor: colors.black, width, height, padding: 20 }}>
                    ...
                    <View style={{ width: width * 0.85, alignSelf: 'center', marginTop: 15 }}>
                        <DropDownPicker
                            placeholder="Select"
                            multiple={true}
                            min={0}
                            ...
                            theme="LIGHT"
                            style={{ backgroundColor: colors.black, borderColor: colors.white, borderWidth: 2 }}
                    ...
                    <View style={{ width: width * 0.8, marginTop: 10 }}>
                        <Text style={{ color: colors.white, left: 10, fontSize: 16, justifyContent: 'center' }} >Company Follow Us
                            <Text style={{ fontSize: 14, color: colors.darkWhite }}>(optional)</Text></Text>
                        <View style={{ flexDirection: 'row', }}>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>f</Text>
                            </View>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>i</Text>
                            </View>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>w</Text>
                            </View>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>t</Text>
                            </View>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>y</Text>
                            </View>
                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                <CheckBox checked={check1} onPress={() => setCheck1(!check1)} style={{ borderColor: colors.black }} />
                                <Text style={{ color: colors.white, alignSelf: 'center', right: 10 }}>p</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.fieldSet}>
