    ...
    return (
        <View>
            ...
            <View style={nonestyle1 ? styles.fieldSet : styles.fieldSet1}  >
                <Text style={nonestyle1 ? styles.legend : styles.legend1}>  Enter Your Name  </Text>
...
const styles = StyleSheet.create({
    ...
    textbox: { color: colors.white, width: width * 0.80, height: Platform.OS === 'ios' ? 45 : 45, borderRadius: 5, textAlign: 'center', fontSize: 16 }
});